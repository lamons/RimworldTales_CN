...
<html>
    <head>
        <title>Rimworld Tales 边缘世界物语</title>
        <style type="text/css">
    ...
    for lines in csvdb:
        if lines["chinese_title"]:
            ...
            if int(lines["picid"]) == 121:
                ...
                file.write("<a href=\"../pages/" + str(int(lines["picid"])+1) + ".html\">下一章</a>・<a href=\"https://srgrafo.com/comics/RimworldTales/" + lines["picid"] + "\">原版链接</a>・<a href=\"../index.html\">回目录</a></p>")
